package renderEngine.shaders.player;
...
public class PlayerShader extends ShaderProgram {
    ...
    private static final String VERTEX_FILE = "/playerVertex.shader";
    private static final String FRAGMENT_FILE = "/playerFragment.shader";
